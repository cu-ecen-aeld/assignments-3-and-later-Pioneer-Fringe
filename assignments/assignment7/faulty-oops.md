...
This analysis shows an example of kernel oops message and how to trace the error.

## Environment Setup
QEMU emulated Buildroot system running from repository [https://github.com/cu-ecen-aeld/assignment-5-Pioneer-Fringe.git]
LDD driver modules from repository [https://github.com/cu-ecen-aeld/assignment-7-Pioneer-Fringe.git]

### Running Buildroot Image
```
Booting Linux on physical CPU 0x0000000000 [0x410fd034]
Linux version 5.15.18 (zding@Ubuntu) (aarch64-buildroot-linux-uclibc-gcc.br_real (Buildroot 2022.02.12-1-g8dd8f39494) 10.4.0, GNU ld (GNU Binutils) 2.36.1) #1 SMP Fri Feb 16 02:47:23 EST 2024
...
rtc-pl031 9010000.pl031: setting system clock to 2024-05-26T04:52:02 UTC (1716699122)
...
Loading hello module with modprobe
Hello, world by Pioneer-Fringe
Starting aesdsocket
```

## Repro Steps
### Run following command to reproduce the oops error message
```
...
Data abort info:
  ...
  CM = 0, WnR = 1
user pgtable: 4k pages, 39-bit VAs, pgdp=0000000042103000
...
sp : ffffffc008d0bd80
x29: ffffffc008d0bd80 x28: ffffff80020dbfc0 x27: 0000000000000000
x26: 0000000000000000 x25: 0000000000000000 x24: 0000000000000000
x23: 0000000040001000 x22: 0000000000000012 x21: 00000055678f2a70
x20: 00000055678f2a70 x19: ffffff8002094d00 x18: 0000000000000000
...
Unable to handle kernel NULL pointer dereference at virtual address 0000000000000000
```
Error is referencing NULL pointer in kernel space, 0000000000000000 is not a valid pointer/memory address to be read or write.
```
pc : faulty_write+0x14/0x20 [faulty]
```
Error is happening in module "faulty" 20 bytes into function faulty_write, which is 32 bytes long.
...
```
Function "faulty_write" attempts writing to address 0 (NULL pointer essentially), which results in the oops error message.
